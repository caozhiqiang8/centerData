...
def getMap():
    ...
    data = {
        ...
        'y23_24_1': province_data[0],
        'y22_23_2': province_data[1],
        'y22_23_1': province_data[2],
        'y21_22_2': province_data[3],
        'y21_22_1': province_data[4],
        'y20_21_2': province_data[5],
        'y20_21_1': province_data[6],
        'y19_20_2': province_data[7],
        'y19_20_1': province_data[8],
        'y18_19_2': province_data[9],
        'y18_19_1': province_data[10],
        'y17_18_2': province_data[11],
        'yearCount': year_data[::-1][1:],
    }
    return data
