...
def year_province_count():
    provinceInfo = pd.DataFrame(
        ...
        columns=['province'])
    years = {
        'y23_24_1': ['2023-07-15', '2024-01-15'],
        'y22_23_2': ['2023-01-15', '2023-07-15'], 'y22_23_1': ['2022-07-15', '2023-01-15'],
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if now_time.strftime("%H") >= '04':
            ...
            pad_license_dau(b_time=b_time, e_time=e_time, group_by_time='1h', index=index,
                            table_name='pad_license_dau_h',
                            if_exists='replace')
